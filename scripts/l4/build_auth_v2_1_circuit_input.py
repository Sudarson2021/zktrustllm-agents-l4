...
PAYLOAD_FILE = OUT_DIR / "proof_payload.auth_v2_1.json"
OUT_FILE = OUT_DIR / "circuit_input.auth_v2_1.json"
...
def main():
    ...
    circuit_input = {
        ...
        "description": "First AUTH_V2.1 circuit input with policy admissibility binding",
    ...
    print("Saved AUTH_V2.1 circuit input ->", OUT_FILE)
