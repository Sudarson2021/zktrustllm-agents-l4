...
art = json.load(open(root / "artifacts" / "contracts" / "l4" / "generated" / "AuthV2Verifier.sol" / "Verifier.json"))
proof = json.load(open(root / "artifacts" / "out_l4" / "zokrates_docker_auth_v2" / "proof.frozen.json"))

w3 = Web3(Web3.HTTPProvider("http://127.0.0.1:8545"))
v = w3.eth.contract(
    address=Web3.to_checksum_address(dep["authV2Groth16Verifier"]),
    abi=art["abi"],
)
...
print("Direct AUTH_V2 verifyTx ->", v.functions.verifyTx((a, b, c), inputs).call())
