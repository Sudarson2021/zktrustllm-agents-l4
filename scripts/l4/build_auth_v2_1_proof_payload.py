...
OUT_FILE = OUT_DIR / "proof_payload.auth_v2_1.json"
...
def main():
    payload = {
        "relationVersion": "auth_v2_1_relation",
    ...
    payload["notes"] = {
        "purpose": "First AUTH_V2.1 control-plane-aware proof payload with policy admissibility",
        "source": "Aligned with positive policy-enforce/isolate admissible path"
    }

    with open(OUT_FILE, "w") as f:
        json.dump(payload, f, indent=2)

    print("Saved AUTH_V2.1 proof payload ->", OUT_FILE)
