...
CIRCUIT_INPUT_FILE = OUT_DIR / "circuit_input.auth_v2.json"
ZOKRATES_JSON_FILE = OUT_DIR / "zokrates_input.auth_v2.json"
FLAT_ARGS_FILE = OUT_DIR / "auth_v2.flat_args.txt"
...
def main():
    ...
    print("Saved AUTH_V2 ZoKrates input ->", ZOKRATES_JSON_FILE)
    print("Saved AUTH_V2 flat args    ->", FLAT_ARGS_FILE)
